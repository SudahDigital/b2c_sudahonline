    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header mx-auto">
                <a href="{{url('/', $client_slug) }}">
                    <img src="{{ asset('assets/image/'.$client_slug.'/logo-gentong.png') }}" width="70%" height="auto" class="d-inline-block align-top" alt="logo" loading="lazy">
                </a>
            </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="z-index: 1.5;">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand nav-center" href="{{ url('/') }}">
                        <img src="{{ asset('assets/image/'.$client_slug.'/logo-gentong.png') }}" class="p-0 m-0 d-inline-block align-top" alt="logo" loading="lazy">
                    </a>
        ...
        <footer id="footer">
            <div class="d-flex justify-content-center">
                <div class="col-md-6">
                    <img src="{{ asset('assets/image/'.$client_slug.'/logo-gentong.png') }}" class="img-thumbnail" style="background-color:transparent; border:none;" alt="logo"> 
                </div>
            </div>
            <br><br>
                    ...
                    success: function (response){
                        if (response == 'taken'){
                            $.ajax({
                                ...
                                url : client+'/keranjang/apply_code',
                                type: 'POST',
                                data:{
                                    code : voucher_code
                                },
                ...
                else 
                {
                    ...
                    $.ajaxSetup({
                        ...
                        $.ajax({
                            ...
                            url : client+'/keranjang/min_order',
                            type:'POST',
                            data:{
