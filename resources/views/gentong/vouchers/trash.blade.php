	...
	<table class="table table-bordered table-striped table-hover dataTable js-basic-example">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<button type="button" class="btn btn-danger btn-xs waves-effect" data-toggle="modal" data-target="#deleteModal{{$v->id}}" style="margin-bottom:5px;"><i class="material-icons">delete</i></button>&nbsp;
					<button type="button" class="btn bg-grey waves-effect" data-toggle="modal" data-target="#restoreModal{{$v->id}}"><small>Restore</small></button>
		           ...
		           <!-- Modal Resotore -->
				   <div class="modal fade" id="restoreModal{{$v->id}}" tabindex="-1" role="dialog">
					<div class="modal-dialog modal-sm" role="document">
