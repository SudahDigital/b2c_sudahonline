@extends('admin.layouts.template-nobanner')
@section('content')
            ...
            <div class="col-sm-8">
                <form method="POST" action="{{ route('login', [$client_slug]) }}">
                    ...
                    <div class="col-md-12 mx-auto text-center">
                        ...
                        <button type="submit" class="btn btn_login_form" style="background: #009973 !important">Sign In
                        </button>
                    </div>
                </form>
            </div>
